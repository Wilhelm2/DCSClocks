...
const char *IntVecACKDescriptor::getFieldProperty(int field,
...
const char *IntVecACKDescriptor::getFieldDynamicTypeString(void *object,
...
std::string IntVecACKDescriptor::getFieldValueAsString(void *object, int field,
		int i) const {
	omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
	if (basedesc) {
		if (field < basedesc->getFieldCount())
...
bool IntVecACKDescriptor::setFieldValueAsString(void *object, int field, int i,
...
void *IntVecACKDescriptor::getFieldStructValuePointer(void *object, int field,
		int i) const {
	omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
	if (basedesc) {
		if (field < basedesc->getFieldCount())
...
unsigned int AckComponent::getAckComponent() const {
	return this->ackComponent;
}

void AckComponent::setAckComponent(unsigned int ackComponent) {
	this->ackComponent = ackComponent;
}

unsigned int AckComponent::getDelay() const {
	return this->delay;
}

void AckComponent::setDelay(unsigned int delay) {
	this->delay = delay;
}
...
const char *AckComponentDescriptor::getProperty(
		const char *propertyname) const {
	omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
	return basedesc ? basedesc->getProperty(propertyname) : nullptr;
}
...
unsigned int AckComponentDescriptor::getFieldTypeFlags(int field) const {
	...
	static unsigned int fieldTypeFlags[] = { FD_ISCOMPOUND | FD_ISCOBJECT,
			FD_ISEDITABLE, FD_ISEDITABLE, FD_ISEDITABLE, };
...
const char *AckComponentDescriptor::getFieldName(int field) const {
	...
	static const char *fieldNames[] = { "component", "sourceId", "ackComponent",
			"delay", };
...
int AckComponentDescriptor::findField(const char *fieldName) const {
	...
	if (fieldName[0] == 's' && strcmp(fieldName, "sourceId") == 0)
		return base + 1;
	if (fieldName[0] == 'a' && strcmp(fieldName, "ackComponent") == 0)
		return base + 2;
...
const char *AckComponentDescriptor::getFieldTypeString(int field) const {
	...
	static const char *fieldTypeStrings[] = { "IntVecACK", "unsigned int",
...
const char *AckComponentDescriptor::getFieldProperty(int field,
		const char *propertyname) const {
	omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
	if (basedesc) {
		if (field < basedesc->getFieldCount())
...
const char *AckComponentDescriptor::getFieldDynamicTypeString(void *object,
		int field, int i) const {
	omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
	if (basedesc) {
		if (field < basedesc->getFieldCount())
...
std::string AckComponentDescriptor::getFieldValueAsString(void *object,
		int field, int i) const {
	omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
	if (basedesc) {
		if (field < basedesc->getFieldCount())
	...
	case 2:
		return ulong2string(pp->getAckComponent());
	case 3:
...
bool AckComponentDescriptor::setFieldValueAsString(void *object, int field,
	...
	case 1:
		...
		return true;
	case 2:
		pp->setAckComponent(string2ulong(value));
		return true;
	case 3:
...
void *AckComponentDescriptor::getFieldStructValuePointer(void *object,
		int field, int i) const {
	omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
	if (basedesc) {
		if (field < basedesc->getFieldCount())
